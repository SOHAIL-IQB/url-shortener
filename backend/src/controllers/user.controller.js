...
const FetchAllUrlsOfTheUserUsingUserIdController = async (req, res) => {
  try {
    ...
    const IsUserPresentUsingUserIdServiceResult =
      await IsUserPresentUsingUserIdService(userId);
    ...
    const GetURLsOfTheUserUsingUserIdServiceResult =
      await GetURLsOfTheUserUsingUserIdService(userId);
    ...
    console.log(
      `Error in FetchAllUrlsOfTheUserUsingUserIdController with err : ${err}`
    );
...
const DeleteUserByUserIdController = async (req, res) => {
  try {
    ...
    const UserToDeleteDetail = await IsUserPresentUsingUserIdService(
      userIdToDelete
    );
    ...
    // delete user
    const DeleteUserByUserIdControllerResult = await DeleteUserByUserIdService(
      userIdToDelete
    );
